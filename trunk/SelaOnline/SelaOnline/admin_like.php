				...
				<div class="div_admin_group_content_inside" style="width: 100%; top: -20px;">
				    <table id="tblPopUp" style="width: 100%;" border="0" cellpadding="2" cellspacing="0">
						...
						<tr>
							...
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtLikeAmount' name='txtLikeAmount' value='' style='width: 49.5%;'  maxlength='0' type='text'></td>
						</tr>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>UnlikeAmount</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtUnlikeAmount' name='txtUnlikeAmount' value='' style='width: 49.5%;'  maxlength='0' type='text'></td>
						</tr>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>LIkeUsers</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><texarea id='txtLIkeUsers' name='txtLIkeUsers' value='' style='width: 49.5%;'  maxlength='65535' type='text'></td>
						</tr>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>UnlikeUsers</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><texarea id='txtUnlikeUsers' name='txtUnlikeUsers' value='' style='width: 49.5%;'  maxlength='65535' type='text'></td>
						</tr>
                        </tbody>
                    </table>
				</div>
