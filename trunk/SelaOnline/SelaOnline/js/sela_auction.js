...
{		   
    ...
    var ACT_GET = 15;
    var _strPage = "admin_auction.php";
    ...
    function btnSave_OnClick() {
		...
		var startingPrice = core.trim(core.getObject("txtStartingPrice").val());
		core.ValidateInputTextBox('txtStartingPrice','');
		if(startingPrice == ''){
			core.ValidateInputTextBox('txtStartingPrice','StartingPrice is required', isValid);
			isValid =  false;
		}
		var numOffer = core.trim(core.getObject("txtNumOffer").val());
		core.ValidateInputTextBox('txtNumOffer','');
		if(numOffer == ''){
			core.ValidateInputTextBox('txtNumOffer','NumOffer is required', isValid);
			isValid =  false;
		}
    ...
    function edit() {
        ...
        strRequest = "?isAJ=1&act=" + ACT_UPDATE +  
			...
			'&StartingPrice='+ core.urlencode(startingPrice)+
			'&NumOffer='+ core.urlencode(numOffer)+
    ...
    function deleteObj(id, name) {
        //curRow = currentRowId;
        popDiv.alert('Do you want to delete ' + name + ' ?', SYSTEM_TITLE_ERROR, 2, "_objAuction.delete_OK()", "_objAuction.delete_Cancel()");
        ...
        if (xmlHTTPRequest.readyState == 4) {
            if (xmlHTTPRequest.status == 200) {
                ...
                if (parseInt(strRespond[1]['rs']) == 1) {
					...
					core.getObject('txtStartingPrice').val(StartingPrice);
					core.getObject('txtNumOffer').val(NumOffer);
    ...
    function showAddMode() {
		...
		core.getObject('txtStartingPrice').val('');
