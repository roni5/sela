...
{		   
    ...
    function btnSave_OnClick() {
		...
		var roleName = core.trim(core.getObject("txtRoleName").val());
		core.ValidateInputTextBox('txtRoleName','');
		if(roleName == ''){
			core.ValidateInputTextBox('txtRoleName','RoleName is required', isValid);
			isValid =  false;
		}else if (roleName.length > 50) {
			core.ValidateInputTextBox('txtRoleName','RoleName must be less than 50', isValid);
			isValid =  false;
		}
    ...
    function edit() {
        ...
        strRequest = "?isAJ=1&act=" + ACT_UPDATE +  
			...
			'&RoleName='+ core.urlencode(roleName)+
    ...
    function deleteObj(id, name) {
        //curRow = currentRowId;
        popDiv.alert('Do you want to delete ' + name + ' ?', SYSTEM_TITLE_ERROR, 2, "_objRole.delete_OK()", "_objRole.delete_Cancel()");
        ...
        if (xmlHTTPRequest.readyState == 4) {
            if (xmlHTTPRequest.status == 200) {
                ...
                if (parseInt(strRespond[1]['rs']) == 1) {
					...
					core.getObject('txtRoleName').val(RoleName);
    ...
    function showAddMode() {
		...
		core.getObject('txtRoleName').val('');
		core.getObject('txtStatus').val('');
    }
    //endregion   
}
var _objRole = new  Role();
