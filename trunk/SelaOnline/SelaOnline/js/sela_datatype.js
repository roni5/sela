...
{		   
    ...
    var ACT_GET = 15;
    var _strPage = "admin_datatype.php";
    ...
    function btnSave_OnClick() {
		...
		var dataTypeName = core.trim(core.getObject("txtDataTypeName").val());
		core.ValidateInputTextBox('txtDataTypeName','');
		if(dataTypeName == ''){
			core.ValidateInputTextBox('txtDataTypeName','DataTypeName is required', isValid);
			isValid =  false;
		}else if (dataTypeName.length > 50) {
			core.ValidateInputTextBox('txtDataTypeName','DataTypeName must be less than 50', isValid);
			isValid =  false;
		}
    ...
    function edit() {
        ...
        strRequest = "?isAJ=1&act=" + ACT_UPDATE +  
			...
			'&DataTypeName='+ core.urlencode(dataTypeName)+
    ...
    function deleteObj(id, name) {
        //curRow = currentRowId;
        popDiv.alert('Do you want to delete ' + name + ' ?', SYSTEM_TITLE_ERROR, 2, "_objDatatype.delete_OK()", "_objDatatype.delete_Cancel()");
        ...
        if (xmlHTTPRequest.readyState == 4) {
            if (xmlHTTPRequest.status == 200) {
                ...
                if (parseInt(strRespond[1]['rs']) == 1) {
					...
					core.getObject('txtDataTypeName').val(DataTypeName);
    ...
    function showAddMode() {
		...
		core.getObject('txtDataTypeName').val('');
		core.getObject('txtStatus').val('');
    }
    //endregion   
}
var _objDatatype = new  Datatype();
