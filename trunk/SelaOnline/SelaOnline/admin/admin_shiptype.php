...
$objShipType = new Model_ShipType($objConnection);

if ($_pgR["act"] == model_ShipType::ACT_ADD)
{
	...
	if (global_common::isCLogin())
	{
		...
		$shipTypeID = $_pgR['ShipTypeID'];
		$shipTypeID = global_editor::rteSafe(html_entity_decode($shipTypeID,ENT_COMPAT ,'UTF-8' ));
		$shipTypeName = $_pgR['ShipTypeName'];
...
elseif($_pgR['act'] == model_ShipType::ACT_UPDATE)
{
	if (global_common::isCLogin())
	{
		//l?y th?ng tin user
...
elseif($_pgR['act'] == model_ShipType::ACT_CHANGE_PAGE)
{
	$intPage = $_pgR['p'];
	
	$outPutHTML =  $objShipType->getListShipType($intPage);
	echo global_common::convertToXML($strMessageHeader, array('rs','inf'), array(1,$outPutHTML),array(0,1));
	return ;
}
elseif($_pgR['act'] == model_ShipType::ACT_SHOW_EDIT)
{
	
	$strShipTypeID = $_pgR['id'];
	$arrShipType =  $objShipType->getShipTypeByID($strShipTypeID);
	
	echo global_common::convertToXML($strMessageHeader, array('rs','ShipTypeID','ShipTypeName',), array(1,'ShipTypeID','ShipTypeName',),array(0,1,1,));
	return ;
}
elseif ($_pgR["act"] == model_ShipType::ACT_GET)
{		
	$sectionID = $_pgR["sect"];
...
elseif($_pgR['act'] == model_ShipType::ACT_DELETE)
{
...
?>
<script type="text/javascript" src="<?php echo $_objSystem->locateJs('sela_ShipType.js');?>"></script>
...
<input type="hidden" id="txtID" name="txtID" value="" />
 <center>
<br><h2 align="center">Mananage ShipType</h2>
		<div class="input-field-border input-field-content" >
				...
				<div class="div_admin_group_content_inside" style="width: 100%; top: -20px;">
				    <table id="tblPopUp" style="width: 100%;" border="0" cellpadding="2" cellspacing="0">
                        <tbody>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>ShipTypeID</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtShipTypeID' name='txtShipTypeID' value='' style='width: 49.5%;'  maxlength='60' type='text'></td>
						</tr>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>ShipTypeName</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtShipTypeName' name='txtShipTypeName' value='' style='width: 49.5%;'  maxlength='150' type='text'></td>
						</tr>
                        </tbody>
                    </table>
				</div>
				...
				<div class="div_admin_group_content_inside" style="margin: 4px; display: block;" align="center">		
				  <input id="btnOK" value="OK"  style="width: 50px;" onClick="_objShipType.btnSave_OnClick()" type="button" class="btn btn-oliver"> &nbsp;&nbsp;&nbsp;
				  <input id="btnClose" value="Cancel" align="center" style="width: 65px;" onClick="_objShipType.showAddMode()" type="button" class="btn btn-oliver">  
			  </div>					
		</div>	
...
<!--End Form Input -->
   ...
   <div  id="content-admin" >
					...
					<div id="list-content" style="padding:10px">
						<?php echo $objShipType ->getListShipType(1) ?>					
						</div>
	</div>
