...
if ($_pgR["act"] == model_Setting::ACT_ADD)
{
	...
	if (global_common::isCLogin())
	{
		...
		$resultID = $objSetting->insert($settingid,$settingname,$settingvalue,$status);
		if ($resultID)
		{
...
elseif($_pgR['act'] == model_Setting::ACT_UPDATE)
{
	if (global_common::isCLogin())
	{
		//l?y th?ng tin user
		...
		$resultID = $objSetting->update($settingid,$settingname,$settingvalue,$status);
...
elseif($_pgR['act'] == model_Setting::ACT_CHANGE_PAGE)
{
	$intPage = $_pgR['p'];
	
	$outPutHTML =  $objSetting->getListSetting($intPage);
	echo global_common::convertToXML($strMessageHeader, array('rs','inf'), array(1,$outPutHTML),array(0,1));
	return ;
}
elseif($_pgR['act'] == model_Setting::ACT_SHOW_EDIT)
{
	
	$strSettingID = $_pgR['id'];
	$arrSetting =  $objSetting->getSettingByID($strSettingID);
	
	echo global_common::convertToXML($strMessageHeader, array('rs','SettingID','SettingName','SettingValue','Status'), array(1,'SettingID','SettingName','SettingValue','Status'),array(0,1,1,1,1));
	return ;
}
elseif ($_pgR["act"] == model_Setting::ACT_GET)
{		
	$sectionID = $_pgR["sect"];
...
elseif($_pgR['act'] == model_Setting::ACT_DELETE)
{
...
?>
<script type="text/javascript" src="<?php echo $_objSystem->locateJs('sela_Setting.js');?>"></script>
...
<input type="hidden" id="txtID" name="txtID" value="" />
 <center>
<br><h2 align="center">Mananage Setting</h2>
		<div class="input-field-border input-field-content" >
				...
				<div class="div_admin_group_content_inside" style="width: 100%; top: -20px;">
				    <table id="tblPopUp" style="width: 100%;" border="0" cellpadding="2" cellspacing="0">
                        <tbody>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>SettingID</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtSettingID' name='txtSettingID' value='' style='width: 49.5%;'  maxlength='60' type='text'></td>
						</tr>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>SettingName</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtSettingName' name='txtSettingName' value='' style='width: 49.5%;'  maxlength='150' type='text'></td>
						</tr>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>SettingValue</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtSettingValue' name='txtSettingValue' value='' style='width: 49.5%;'  maxlength='765' type='text'></td>
						</tr>
						<tr>
				...
				<div class="div_admin_group_content_inside" style="margin: 4px; display: block;" align="center">		
				  <input id="btnOK" value="OK"  style="width: 50px;" onClick="_objSetting.btnSave_OnClick()" type="button" class="btn btn-oliver"> &nbsp;&nbsp;&nbsp;
				  <input id="btnClose" value="Cancel" align="center" style="width: 65px;" onClick="_objSetting.showAddMode()" type="button" class="btn btn-oliver">  
			  </div>					
		</div>	
...
<!--End Form Input -->
   ...
   <div  id="content-admin" >
					...
					<div id="list-content" style="padding:10px">
						<?php echo $objSetting ->getListSetting(1) ?>					
						</div>
	</div>
