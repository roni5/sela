...
if ($_pgR["act"] == model_ArticleType::ACT_ADD)
{
	...
	if (global_common::isCLogin())
	{
		...
		$resultID = $objArticleType->insert($articletypeid,$articletypename,$status);
		if ($resultID)
		{
...
elseif($_pgR['act'] == model_ArticleType::ACT_UPDATE)
{
	if (global_common::isCLogin())
	{
		//l?y th?ng tin user
		...
		$resultID = $objArticleType->update($articletypeid,$articletypename,$status);
...
?>
<script type="text/javascript" src="<?php echo $_objSystem->locateJs('sela_ArticleType.js');?>"></script>
...
<input type="hidden" id="txtID" name="txtID" value="" />
 <center>
<br><h2 align="center">Mananage ArticleType</h2>
		<div class="input-field-border input-field-content" >
				...
				<div class="div_admin_group_content_inside" style="width: 100%; top: -20px;">
				    <table id="tblPopUp" style="width: 100%;" border="0" cellpadding="2" cellspacing="0">
                        <tbody>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>ArticleTypeID</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtArticleTypeID' name='txtArticleTypeID' value='' style='width: 49.5%;'  maxlength='60' type='text'></td>
						</tr>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>ArticleTypeName</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtArticleTypeName' name='txtArticleTypeName' value='' style='width: 49.5%;'  maxlength='150' type='text'></td>
						</tr>
						<tr>
				...
				<div class="div_admin_group_content_inside" style="margin: 4px; display: block;" align="center">		
				  <input id="btnOK" value="OK"  style="width: 50px;" onClick="_objArticleType.btnSave_OnClick()" type="button" class="btn btn-oliver"> &nbsp;&nbsp;&nbsp;
				  <input id="btnClose" value="Cancel" align="center" style="width: 65px;" onClick="_objArticleType.showAddMode()" type="button" class="btn btn-oliver">  
			  </div>					
		</div>	
...
<!--End Form Input -->
   ...
   <div  id="content-admin" >
					...
					<div id="list-content" style="padding:10px">
						<?php echo $objArticleType ->getListArticleType(1) ?>					
						</div>
	</div>
