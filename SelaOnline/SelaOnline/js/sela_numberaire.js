...
{		   
    ...
    var ACT_GET = 15;
    var _strPage = "admin_numberaire.php";
    ...
    function btnSave_OnClick() {
		...
		var numberaireName = core.trim(core.getObject("txtNumberaireName").val());
		core.ValidateInputTextBox('txtNumberaireName','');
		if(numberaireName == ''){
			core.ValidateInputTextBox('txtNumberaireName','NumberaireName is required', isValid);
			isValid =  false;
		}else if (numberaireName.length > 50) {
			core.ValidateInputTextBox('txtNumberaireName','NumberaireName must be less than 50', isValid);
			isValid =  false;
		}
    ...
    function edit() {
        ...
        strRequest = "?isAJ=1&act=" + ACT_UPDATE +  
			...
			'&NumberaireName='+ core.urlencode(numberaireName)+
    ...
    function deleteObj(id, name) {
        //curRow = currentRowId;
        popDiv.alert('Do you want to delete ' + name + ' ?', SYSTEM_TITLE_ERROR, 2, "_objNumberaire.delete_OK()", "_objNumberaire.delete_Cancel()");
        ...
        if (xmlHTTPRequest.readyState == 4) {
            if (xmlHTTPRequest.status == 200) {
                ...
                if (parseInt(strRespond[1]['rs']) == 1) {
					...
					core.getObject('txtNumberaireName').val(NumberaireName);
    ...
    function showAddMode() {
		...
		core.getObject('txtNumberaireName').val('');
		core.getObject('txtStatus').val('');
    }
    //endregion   
}
var _objNumberaire = new  Numberaire();
