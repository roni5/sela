...
{		   
    ...
    var ACT_GET = 15;
    var _strPage = "admin_userrank.php";
    ...
    function btnSave_OnClick() {
		...
		var userRankName = core.trim(core.getObject("txtUserRankName").val());
		core.ValidateInputTextBox('txtUserRankName','');
		if(userRankName == ''){
			core.ValidateInputTextBox('txtUserRankName','UserRankName is required', isValid);
			isValid =  false;
		}else if (userRankName.length > 50) {
			core.ValidateInputTextBox('txtUserRankName','UserRankName must be less than 50', isValid);
			isValid =  false;
		}
    ...
    function edit() {
        ...
        strRequest = "?isAJ=1&act=" + ACT_UPDATE +  
			...
			'&UserRankName='+ core.urlencode(userRankName)+
    ...
    function deleteObj(id, name) {
        //curRow = currentRowId;
        popDiv.alert('Do you want to delete ' + name + ' ?', SYSTEM_TITLE_ERROR, 2, "_objUserRank.delete_OK()", "_objUserRank.delete_Cancel()");
        ...
        if (xmlHTTPRequest.readyState == 4) {
            if (xmlHTTPRequest.status == 200) {
                ...
                if (parseInt(strRespond[1]['rs']) == 1) {
					...
					core.getObject('txtUserRankName').val(UserRankName);
    ...
    function showAddMode() {
		...
		core.getObject('txtUserRankName').val('');
		core.getObject('txtStatus').val('');
    }
    //endregion   
}
var _objUserRank = new  UserRank();
