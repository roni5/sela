...
class global_common
{
	...
	*****************************************************************************/
	...
	const FOLDER_IMAGE_URL						= 'images/';
	const FOLDER_SOUND_URL						= 'sound/'; 
	const FOLDER_CSS_URL						= 'css/'; 
	...
	*/
	...
	/**
	 * Định dạng lại một chuỗi trước khi xuất ra HTML. thay thế những ký tự đặt biệt thành html encode input <b> => output <b> not bold b
	 *
	...
	function formatPlanText($haystack)
	{
